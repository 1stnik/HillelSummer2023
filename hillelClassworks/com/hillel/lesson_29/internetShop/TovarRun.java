package com.hillel.lesson_29.internetShop;
...
public class TovarRun {
    ...
    public static void main(String[] args) {
        ...
        ResourceBundle resourceBundle = ResourceBundle.getBundle("com.hillel.lesson_29.internetShop.tovar.tovar", locale);
